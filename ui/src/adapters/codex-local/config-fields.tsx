...
export function CodexLocalConfigFields({
  ...
  const fastModeMessage = fastModeManualModel
    ...
    : fastModeSupported
      ...
      : `Le mode rapide ne fonctionne actuellement qu'avec ${supportedModelsLabel} ou des identifiants de modèle manuels. Kovv-ia ignorera cette option jusqu'au changement de modèle.`;
