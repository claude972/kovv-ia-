              ...
              <div className="flex items-center gap-0 mb-8 border-b border-border">
                {(
                  [
                    ...
                    { step: 4 as Step, label: "Lancement", icon: Rocket }
                  ] as const
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Choisissez comment cet agent exécutera ses tâches.
                      </p>
                    </div>
                  </div>
                  <div>
                            ...
                            <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2.5 py-1.5 text-sm hover:bg-accent/50 transition-colors w-full justify-between">
                              ...
                              >
                                {selectedModel
                                  ...
                                  : model ||
                                    (adapterType === "opencode_local"
                                      ? "Sélectionnez un modèle (obligatoire)"
                                      : "Défaut")}
                              </span>
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <div>
                          <p className="text-xs font-medium">
                            Vérification de l'environnement de l'adaptateur
                          </p>
                          <p className="text-[11px] text-muted-foreground">
                            Lance une sonde en direct qui demande à l'interface
                            CLI de l'adaptateur de répondre par hello.
                          </p>
                        </div>
                        <Button
                          size="sm"
                        ...
                        >
                          {adapterEnvLoading ? "Test en cours..." : "Tester maintenant"}
                        </Button>
                      </div>
                      ...
                      {shouldSuggestUnsetAnthropicApiKey && (
                        <div className="rounded-md border border-amber-300/60 bg-amber-50/40 px-2.5 py-2 space-y-2">
                          <p className="text-[11px] text-amber-900/90 leading-relaxed">
                            ...
                            est définie. Vous pouvez la supprimer dans la configuration de l'adaptateur CEO
                        ...
                        <div className="rounded-md border border-border/70 bg-muted/20 px-2.5 py-2 text-[11px] space-y-1.5">
                          ...
                          adapterType === "opencode_local" ? (
                            <p className="text-muted-foreground">
                              ...
                              dans l'environnement ou exécutez{" "}
                              <span className="font-mono">
                                {adapterType === "cursor"
                                  ? "agent login"
                                  : adapterType === "codex_local"
                            ...
                            <p className="text-muted-foreground">
                              Si une connexion est requise, exécutez{" "}
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Donnez à votre agent une petite tâche pour commencer — une correction de bug,
                        une question de recherche, l'écriture d'un script.
                      </p>
                    </div>
                  </div>
                  <div>
                    ...
                    <input
                      className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50"
                      placeholder="ex. Analyser les prix de la concurrence"
                      value={taskTitle}
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Tout est configuré. Le lancement va créer la
                        tâche de démarrage, réveiller l'agent et ouvrir le ticket.
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  {step === 4 && (
                    <Button size="sm" disabled={loading} onClick={handleLaunch}>
                      ...
                      {loading ? "Création en cours..." : "Créer et ouvrir le ticket"}
                    </Button>
                  )}
                </div>
              </div>
