...
export const help: Record<string, string> = {
  ...
  workspaceStrategy: "Comment Kovv-ia doit créer un espace de travail d'exécution pour cet agent. Conservez project_primary pour une exécution normale, ou utilisez git_worktree pour des extractions isolées par ticket.",
  ...
  bootstrapPrompt: "Envoyé uniquement lorsque Kovv-ia démarre une nouvelle session. Utilisez ceci pour des instructions stables de configuration qui ne doivent pas être répétées à chaque heartbeat.",
  payloadTemplateJson: "JSON optionnel fusionné dans les charges utiles des requêtes de l'adaptateur distant avant que Kovv-ia n'ajoute ses champs standard de réveil et d'espace de travail.",
